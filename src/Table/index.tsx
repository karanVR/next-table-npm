...
export function DataTable<TData, TValue>({
  ...
  return (
    <div
      ...
      className={cn(
        `rounded-lg relative z-0 flex w-full h-full `,
        isBorder ? "border" : ""
      )}
    >
      <div
                                ...
                                ? () => {
                                    if (cell.column.id === "claim_id") {
                                      const imeiCell = row
                                        .getVisibleCells()
                                        .find(
                                          (c: any) => c.column.id === "imei_no"
                                        );
                                      addItemToTablist({
                                        label: cell.getValue(),
                                        value: cell.getValue(),
                                        imei_number: imeiCell
                                          ? imeiCell.getValue()
                                          : undefined,
                                      });
                                    }
                  ...
                  <div className="w-fit max-w-[310px] flex overflow-hidden gap-1">
                    {getPageNumbers().map((page, index) => {
                      return (
                        <span
                          key={page}
                          className="flex items-center gap-2 overflow "
                        >
                          <PaginationItem
                            className={cn(
