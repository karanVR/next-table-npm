...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (_jsx(ToastPrimitives.Viewport, { ref: ref, className: cn('fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-[48px] sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]', className), ...props })));
